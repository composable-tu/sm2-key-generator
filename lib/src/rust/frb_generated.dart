...
import 'api/sm2_key_generator.dart';
import 'dart:async';
import 'dart:convert';
...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  Future<void> executeRustInitializers() async {
    await api.crateApiSm2KeyGeneratorInitApp();
  }
  ...
  static const kDefaultExternalLibraryLoaderConfig =
      ExternalLibraryLoaderConfig(
        stem: 'rust_lib_sm2_key_generator',
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<(String, String)> crateApiSm2KeyGeneratorGenSm2Key() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiSm2KeyGeneratorGenSm2KeyConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiSm2KeyGeneratorGenSm2KeyConstMeta =>
      const TaskConstMeta(debugName: "gen_sm2_key", argNames: []);
  ...
  Future<void> crateApiSm2KeyGeneratorInitApp() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiSm2KeyGeneratorInitAppConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
